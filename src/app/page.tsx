  ...
  return (
    <main className="mx-auto w-full max-w-4xl space-y-6 px-4 py-8">
      <header className="space-y-1">
        <h1 className="text-2xl font-bold text-stone-900">Read a supplier document</h1>
      ...
      <div aria-live="polite">
        {state.phase === "uploading" && <p className="text-stone-700">Uploading and reading {state.fileName}…</p>}
